...
struct Page: Identifiable, Equatable {
    ...
    static var samplePages: [Page] = [
        Page(name: "Hello!", description: "Welcome to Budget Voyage, an app to help you plan and save for adventures of all kinds", imageUrl: "First", tag: 0),
    ...
    Page(name: "Start Budgeting!", description: "Select the budget tab and enter the total budget you wish to save and the money saving interval you will choose", imageUrl: "Main", tag: 4),
    ]
